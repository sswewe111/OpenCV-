...
```python
# contourIdx 指定要绘制的轮廓编号，传入 -1 表示绘制所有轮廓
...
```python
# 在原图 image 中滑动模板 templ，并计算每个位置的匹配分数
...
# locations 是行列坐标，[::-1] 转成 OpenCV 需要的 x、y 坐标
